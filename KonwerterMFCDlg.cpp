...
void CKonwerterMFCDlg::OnBnClickedButton1()
{
	...
	{
		// Sprawdzamy, czy ci¹g zawiera tylko zera i jedynki
	...
	else if (m_nSelectedSystemCombo1 == 1) // Dec
	{
		// Sprawdzamy, czy ci¹g zawiera tylko cyfry od 0 do 9
	...
	else if (m_nSelectedSystemCombo1 == 2) // Hex
	{
		// Sprawdzamy, czy ci¹g zawiera tylko cyfry od 0 do 9 oraz litery od A do F (lub a do f)
	...
	{
		// Sprawdzamy, czy ci¹g zawiera tylko cyfry od 0 do 7
...
CString CKonwerterMFCDlg::DecimalToBinary(int decimalValue)
{
	...
	{
		// Dodajemy cyfrê binarn¹ z reszty
